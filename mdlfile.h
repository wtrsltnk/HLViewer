...
typedef struct sMDLHeader
{
    ...
    int firstBoneControllerOffset;
    int hitboxCount;
    int firstHitboxOffset;
    int sequenceCount;
    int firstSequenceOffset;
    int sequenceGroupCount;
    int firstSequenceGroupOffset;
    int textureCount;
    int firstTextureOffset;
    int textureDataOffset;
    int skinReferenceCount;
    int skinFamilieCount;
    int firstSkinOffset;
    int bodypartCount;
    int firstBodypartOffset;
    int attachmentCount;
    int firstAttachmentOffset;
    int soundTable;
    int soundOffset;
    int soundGroups;
    int soundGroupOffset;
    int transitionCount;
    int firstTransitionOffset;
...
private:
    tMDLHeader m_header;
    tMDLTexture *m_textures = nullptr;
